...
class DETRHead(AnchorFreeHead):
    ...
    def forward(self, feats, img_metas,vprompt):
        """Forward function.
        ...
        return multi_apply(self.forward_single, feats, img_metas_list,vprompt)

    def forward_single(self, x, img_metas,vprompt):
